        ...
        <b-row class="mb-3 py-5 icon-background">
            <b-col cols='6' offset='1'>
                <div class="profil-img-container">
                    <b-img :src="profileLogged.imageURL" thumbnail class="profile-img" alt="Profile Image"></b-img>        
                </div>
        ...
        <b-row class="py-3 border-bottom">
            ...
            <b-list-group class="w-100">
                <b-list-group-item class="d-flex justify-content-between align-items-center">
                    <span>Prénom :</span>
                    <span>{{profileLogged.firstname.toUpperCase()}}</span>
                </b-list-group-item>
                <b-list-group-item class="d-flex justify-content-between align-items-center">
                    <span>Nom :</span>
                    <span>{{profileLogged.lastname.toUpperCase()}}</span>
                </b-list-group-item>
                <b-list-group-item class="d-flex justify-content-between align-items-center">
                    <span>Poste :</span>
                    <span>{{profileLogged.position}}</span>
                </b-list-group-item>
                <b-list-group-item class="d-flex justify-content-between align-items-center">
                    <span>contact :</span>
                    <span>{{profileLogged.email}}</span>
                </b-list-group-item>
            </b-list-group>
        </b-row>
